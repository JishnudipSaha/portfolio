...
export default function ProjectsPage() {
  ...
  const projects = [
    ...
    },
    {
      ...
      technologies: ["Python", "scikit-learn", "NLTK", "Data Science"],
      categories: ["data"],
    ...
    },
    {
      ...
      image: "./Spam-image-poster.jpg?height=300&width=500",
      technologies: ["NLTK", "scikit-learn", "Python", "Data Science"],
      categories: ["data"],
      github: "https://github.com/JishnudipSaha/sms-spam-classify-project",
      live: "https://jishnu-sms-spam-classify-project.streamlit.app/",
      featured: true,
    },
    {
      id: 5,
      title: "Titanic Survival Prediction",
      description: "An ML-based system that analyzes and predict weather the person will survive or not based on personalized info",
