...
export default function ProjectsPage() {
  ...
  const projects = [
    ...
    },
    {
      ...
      image: "./titanic-image.jpg?height=300&width=500",
      technologies: ["Python", "Meachine learning"],
      categories: ["data"],
      github: "https://github.com/JishnudipSaha/CodSoft-project-titanic",
      live: "https://codsoft-project-titanic-xnn3ejgamep6mabnupasia.streamlit.app/",
      featured: true,
    },
    {
      id: 5,
